...
class GdAbsensiController extends Controller
{
	/**
	...
	{
		$model=new GdAbsensi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GdAbsensi']))
			$model->attributes=$_GET['GdAbsensi'];
	 ...
	 * @return GdAbsensi the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=GdAbsensi::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param GdAbsensi $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gd-absensi-form')
		{
